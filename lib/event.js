const { MessageBus, MessageBusSubscription, MessageBusMessageStatus, MessageBusMessage } = require("component.messagebus");
...
Event.prototype.broadcast = async function() {
